...
namespace SharpConstraintLayout.Maui.Core
{
    ...
    public class Placeholder : View
    {
        ...
        private int mEmptyVisibility = AndroidView.INVISIBLE;
        ...
        private void init()  
        {
            if (mEmptyVisibility == AndroidView.INVISIBLE)
                this.Opacity = 0;//https://stackoverflow.com/questions/28097153/workaround-for-visibilty-hidden-state-windows-phone-8-1-app-development
            else
                base.Visibility = (Microsoft.UI.Xaml.Visibility)mEmptyVisibility;
            mContentId = -1;
            /*if (attrs != null)
            {
       ...
       /* /// <summary>
        ...
        public virtual void updatePreLayout(ConstraintLayout container)
        {
            ...
            if (mContent != null)
            {
                ...
                container.ConstraintSet.Constraints[mContent.GetHashCode()].propertySet.isInPlaceholder = true;
        ...
        public virtual int ContentId
        {
            set
            {
                ...
                if (mContent != null)
                {
                    ...
                    ((mContent.Parent) as ConstraintLayout).ConstraintSet.Constraints[mContent.GetHashCode()].propertySet.isInPlaceholder = true;
                    mContent = null;
                }
                ...
                if (value != ConstraintLayout.LayoutParams.UNSET)
                {
                    ...
                    View v = ((ConstraintLayout)Parent).findViewById(value);
                    if (v != null)
                    {
        ...
        public virtual void updatePostMeasure(ConstraintLayout container)
        {
            ...
            layoutParamsContent.Visibility = (int)Microsoft.UI.Xaml.Visibility.Visible;
            ...
            layoutParamsContent.Visibility = (int)Microsoft.UI.Xaml.Visibility.Collapsed;
        }
    }
