...
namespace SharpConstraintLayout.Maui.Core
{
    ...
    /// </para>
    /// </summary>
    public abstract partial class ConstraintHelper : FrameworkElement
    {
        ...
        protected internal virtual void init(object attrs=null)
        {
            /*if (attrs != null)
            {
            ...
            this.Loaded += onAttachedToWindow;
        }

        public virtual  void onAttachedToWindow(object sender, RoutedEventArgs e)
        {
